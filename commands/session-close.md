...
8. **Confirm to the user** what changed, whether a commit was made, and explicitly list anything still open in `## Open items` — closing a PR (or marking done) does not auto-resolve those; the user should say which ones are actually done.
